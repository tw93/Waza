...
when_to_use: "review, 看看代码, 检查一下, 有没有问题, 是否需要优化, 合并前, 继续优化, 优化代码, 看看issue, 看看PR, CR, PR review, code review, refactor, smell, 发布, 提交, 关闭issue, 发布表情, release表情, draft release, publish, 项目体检, 项目评分, 给项目打分, 深入分析项目代码, 评估项目质量, 代码质量评分, audit project, score project, rate codebase, 코드봐줘, 리뷰해줘, 머지해도되나, 릴리즈, 발행, release, code-review, audit, project audit, scorecard, linus review, rate this codebase, score this project"
